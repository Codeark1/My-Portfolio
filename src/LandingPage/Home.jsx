...
const Home = () => {
  return (
    <div className="min-h-screen bg-about" id="home ">
    <nav className=" bg-[#164E94] flex items-center justify-between h-16 md:h-20 px-4 md:px-10">
    ...
    <section className="  grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 md:h-80 px-4 md:px-10 py-8">
      <div className=" text-black md:text-3xl lg:text-4xl flex justify-center items-center font-semibold">
        <Typewriter
          options={{
            strings: [
      ...
      <div className="flex flex-col justify-center items-center mt-8 md:mt-0">
        <div className="rounded-full overflow-hidden">
          <img
            src={pic}
            alt=""
            className="object-cover w-32 md:w-60 h-32 md:h-60"
          />
        </div>
