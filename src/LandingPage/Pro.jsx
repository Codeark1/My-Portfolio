...
const Pro = () => {
    const projects = [
        ...
        },
        {
          ...
          title: "IP TRACKER",
          about:
            "Ip Tracker is a powerful yet user-friendly IP tracking application designed to provide you with real-time information about the geographical location With just an IP address,",
          stack: "HTML,CSS,JS",
          gitLink: <img src={github} alt="" />,
        ...
        },
        {
          ...
          about:
            "The Age Calculator is a user-friendly and versatile tool designed to calculate a person's age based on their birth date and the current date. Whether you need to determine your own age or calculate someone else's age, this handy application makes the process quick and effortless.",
          stack: " HTML,CSS, JS",
    ...
    <div>
        <Layout>
            <Sider width={100} style={{backgroundColor:"white"}}>
              <div className=' bg-teal-800 h-full'> </div>
            </Sider>
<Content className="min-h-full " id="project">
      ...
      <section className="grid gap-5 mt-10 pl-5 pr-5 md:grid-cols-2 lg:grid-cols-3">
        {projects.map((project, index) => (
          <div
            key={index}
            className="p-3 border rounded-md first-letter:text-center font-[poppins-600] text-black break-normal shadow-sm h-[100svh]"
          >
            <div className=" h- ">{project.img}</div>
